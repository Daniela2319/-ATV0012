...
produto.SetNomeProduto("computador");
produto.SetPreco(50.00m);
produto.AdicionarFornecedor(fornecedor);

Produto produto2 = new Produto("impressora", 80.00m, fornecedor);
...
//Produto produtoUsuario = new Produto(nomeProduto, precoProduto, fornecedorUsuario);
